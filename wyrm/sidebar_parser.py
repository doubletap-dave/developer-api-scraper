...
def save_structure_map(structure_map: list[dict], filepath: str) -> None:
    """Saves the structured sidebar map to a JSON file."""
    try:
...
def load_structure_map(filepath: str) -> list[dict] | None:
    """Loads the structured sidebar map from a JSON file."""
